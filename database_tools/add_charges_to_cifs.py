...
# Settings
cif_folder_path = r'/path/to/qmof-cifs'  # path to folder of CIFs (e.g. after running xyz_to_cifs.py)
charge_xlsx_path = r'/path/to/qmof-ddec-charges.xlsx'  # path to .xlsx file of (e.g. DDEC) charges
...
new_cif_folder_path = r'/path/to/qmof_cifs_with_charges'  # path to empty folder where new CIFs should be stored
