...
). In these cases, only the free solvent removed structures were adopted. A curated subset of CoRE MOFs was considered from [Kancharlapalli et al.](https://pubs.acs.org/doi/abs/10.1021/acs.jctc.0c01229) to reduce the likelihood of obtaining erroneous crystal structures.
