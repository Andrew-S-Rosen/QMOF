...
# Changelog
- [v5](https://figshare.com/articles/dataset/QMOF_Database/13147324/5): Release corresponding to the forthcoming published paper. No changes to the database compared to v3. Fixes a bug in `get_subset.py` that did not correctly write out the updated `.json` file. 2/12/21.
