...
# Changelog
- [v4](https://figshare.com/articles/dataset/QMOF_Database/13147324/4): Updated naming convention of subsets from CSD-#-opt/SP to QMOF-#-opt/SP. Otherwise. no changes were made to the QMOF database. 01/11/21.
