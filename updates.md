...
# Changelog
- [v4](https://figshare.com/articles/dataset/QMOF_Database/13147324/4): Release corresponding to the published paper. No changes to the database itself compared to v3. Includes a few minor typo fixes and better .xlsx reader. 1/12/21.
