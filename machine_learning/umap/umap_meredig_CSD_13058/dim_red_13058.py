...
seed = 42  # random seed
x = os.path.join(
    '..', '..', 'stoichiometric_120', 'CSD-13058', 'meredig_fingerprints_13058.csv')  # .csv of X encodings
bandgaps_path = os.path.join(
    '..', 'CSD-13058-opt-bandgaps.csv') # .csv of y properties
...
plt.savefig('umap_13058.png', transparent=False)
